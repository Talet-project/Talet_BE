...
@ApiResponses({
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        schema = @Schema(implementation = ApiResponseLookingBookResponse.class),
                        examples = @ExampleObject(name = "조회 성공", value = SwaggerExamples.BOOK_LOOKING_OK)
                )
        ),
        @ApiResponse(
                responseCode = "400",
